...
chain_lengths=['1st','2nd','3rd','4th','5th']
folders=[]
for i in range(len(chain_lengths)):
    folders.append('chain_length_50_'+chain_lengths[i]+'/Monitor.dat')
j=0
...
for sim in folders:
    ...
    j=j+1
master_output.to_csv('checking_different_seed__master_out.csv',index=False)
