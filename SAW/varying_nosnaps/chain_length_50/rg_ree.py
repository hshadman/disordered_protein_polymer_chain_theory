...
chain_lengths=['200','2000','10000','15000','20000','200000']
folders=[]
for i in range(len(chain_lengths)):
    folders.append('chain_length_50_'+chain_lengths[i]+'snaps'+'/Monitor.dat')
j=0
...
for sim in folders:
    ...
    j=j+1
master_output.to_csv('varying_nosnaps_master_out.csv',index=False)
