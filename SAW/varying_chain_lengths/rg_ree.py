...
chain_lengths=['10','25','50','75','100','125','150','250','500','1000']
folders=[]
for i in range(len(chain_lengths)):
    folders.append('chain_length_'+chain_lengths[i]+'/Monitor.dat')
j=0
...
for sim in folders:
    ...
    j=j+1
master_output.to_csv('varying_chain_lengths_master_out.csv',index=False)
