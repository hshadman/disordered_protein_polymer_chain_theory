...
chain_lengths=['500','1000','5000','10000','15000','20000','22500','25000','30000','45000','50000']
folders=[]
for i in range(len(chain_lengths)):
    folders.append('chain_length_50_'+chain_lengths[i]+'interval'+'/Monitor.dat')
j=0
...
for sim in folders:
    ...
    j=j+1
master_output.to_csv('varying_interval_master_out.csv',index=False)
